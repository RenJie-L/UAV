...
{  
 ...
 // double goal[3][3]={{0,-0.4,0.3},{0,0,0.3},{0,0.4,0.3}};
//  double goal[2][3]={{0,-0.4,0.3},{0,0.4,0.3}};
double goal[1][3]={0,0,0.34};
/**************************************************************************************/
     ...
     z[0]=goal[i][2];
        ...
        else
        {
            ...
            else
            {
               ...
               double po_x=(pose.pose.position.x-y[0])*(pose.pose.position.x-y[0]);
               double po_y=(pose.pose.position.y-x[0])*(pose.pose.position.y-x[0]);
	       if(sqrt(po_x+po_y)<0.5)
              {break;}
            }
