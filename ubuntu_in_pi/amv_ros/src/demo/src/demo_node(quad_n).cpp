...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
     ...
     ros::Subscriber optitrack_sub = nh.subscribe<geometry_msgs::PoseStamped>("/vrpn_client_node/Trackable2/pose", 100, optitrack_cb);
    ...
    double dx[2][2]={{0,0},{-0.3,0}};
    double dy[2][2]={{0,0},{-0.52,0}};
